    ...
    <div class="card">
        ...
        @if($users->count())
            <div class="card-header">
                <div class="px-6 py-4">
                    ...
                    <a class="btn btn-info btn-sm" href="{{route('admin.users.pdfpki',['opcion'=>'titular', 'busqueda'=>$search])}}">Generar PDF</a>
                </div>
            </div>
        ...
        @else
            <div class="card-body align-center">
                <strong>No existen registros de usuarios TITULARES</strong>
            </div>
        @endif
    </div>
</div>
